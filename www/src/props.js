...
export const PropertyConfig = [{
    key: "general", section: "General", props: [
        ...
        {key: "brightness", title: "Brightness", type: "wheel", limit: 4095, size: 2, kind: "Uint16", cmd: PacketType.BRIGHTNESS},
    ],
}, {
    key: "night_mode", section: "Night Mode", lock: true, props: [
        ...
        {key: "nightMode.brightness", title: "Brightness", type: "wheel", limit: 4095, size: 2, kind: "Uint16", cmd: PacketType.NIGHT_MODE_BRIGHTNESS},
